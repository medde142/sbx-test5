...
/* ... vollständiger Code wie in Canvas oben ... */
...
export default function SBXProjektStart() {
  ...
  const handleSubmit = () => {
    ...
    // Hier später Übergabe an Backend oder nächste Seite
  };
      ...
      <Card className="shadow-xl">
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            {[{label:"GU-Leistungen",key:"gu"},{label:"Möbelfertigung",key:"moebel"},{label:"Logistik",key:"logistik"},{label:"Montage",key:"montage"},{label:"Elektro / HLS-Koordination",key:"elektro"},{label:"Projektsteuerung",key:"projektsteuerung"}].map((item) => (
          ...
          <div className="space-y-2">
            ...
            {[{label:"Osmoseanlage",key:"osmoseanlage"},{label:"Eismaschine",key:"eismaschine"},{label:"Mastrena",key:"mastrena"},{label:"Beleuchtung (ITAB)",key:"beleuchtungITAB"},{label:"Werbeanlage (Zuleitung)",key:"werbeanlageZuleitung"},{label:"WUM Möbelkontrolle",key:"mobelWUM"}].map((item) => (
              <div key={item.key} className="flex items-center space-x-2">
